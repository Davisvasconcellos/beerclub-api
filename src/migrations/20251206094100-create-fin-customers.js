...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    try {
      await queryInterface.createTable('fin_customers', {
      ...
      await queryInterface.addIndex('fin_customers', ['store_id'], { name: 'idx_fin_customers_store_id', transaction: t });
      await queryInterface.addIndex('fin_customers', ['document'], { name: 'idx_fin_customers_document', transaction: t });
      await queryInterface.addIndex('fin_customers', ['id_code'], { name: 'idx_fin_customers_id_code', transaction: t });
  ...
  down: async (queryInterface) => {
    await queryInterface.dropTable('fin_customers');
  }
};
