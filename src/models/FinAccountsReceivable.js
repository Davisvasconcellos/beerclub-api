...
const FinAccountsReceivable = sequelize.define('FinAccountsReceivable', {
  ...
  status: { type: DataTypes.ENUM('pending', 'paid', 'overdue', 'canceled', 'partial'), allowNull: false, defaultValue: 'pending' },
...
module.exports = FinAccountsReceivable;
